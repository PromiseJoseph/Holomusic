            ...
            <section id="hero" className="hero d-flex align-items-center">
                ...
                <div className="row" >
                    ...
                    <div className="d-flex" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <a href="https://www.youtube.com/watch?v=LXb3EKWsInQ" className="glightbox btn-watch-video d-flex align-items-center"><i className="bi bi-play-circle"></i><span>Play Music</span></a>
                    </div>
